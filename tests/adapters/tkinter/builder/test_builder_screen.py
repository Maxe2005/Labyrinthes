...
def test_mount_renders_a_home_builder_breadcrumb(tk_root, navigate_stub, find_all):
    navigate, _ = navigate_stub
    frame = mount(tk_root, None, navigate)
...
def test_breadcrumb_trailing_builder_segment_has_no_click_handler(tk_root, navigate_stub, find_all):
    navigate, _ = navigate_stub
    frame = mount(tk_root, None, navigate)
